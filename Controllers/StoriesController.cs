        ...
        public async Task<IActionResult> ApproveStory(int id, Story story)
        {
            try
            {
                ...
                if (str != null)
                {
                    ...
                    var result = await ssDb.storyDb.Approve(id);
                    ...
                    {
                        return StatusCode(500, "Failed to approve story");
                    }
                }
                else
                {
        ...
        public async Task<ActionResult<Story>> PostStory(Story story)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    var result = await ssDb.storyDb.Create(story);
                    ...
                    {
                        return StatusCode(500, "Failed to save story to database");
                    }
                }
                else
                {
